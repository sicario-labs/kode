 ...
 *   "@kode/ServerAuthConfig",
 *   {
 *     password: Config.string("KODE_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("KODE_SERVER_USERNAME").pipe(Config.withDefault("kode")),
 *   },
 * ) {}
 *
