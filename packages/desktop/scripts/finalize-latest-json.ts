...
const releaseId = process.env.KODE_RELEASE
if (!releaseId) throw new Error("KODE_RELEASE is required")

const version = process.env.KODE_VERSION
if (!version) throw new Error("KODE_VERSION is required")
...
const macxTarGz = "kode-desktop-mac-x64.app.tar.gz"
const macaTarGz = "kode-desktop-mac-arm64.app.tar.gz"
