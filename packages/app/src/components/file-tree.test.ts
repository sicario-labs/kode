...
beforeAll(async () => {
  ...
  mock.module("@kode/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@kode/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@kode/ui/icon", () => ({ Icon: () => null }))
  mock.module("@kode/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
