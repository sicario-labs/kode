...
import { Switch } from "@kode/ui/switch"
        ...
        <SettingsRow
          ...
          description={
            <>
              ...
              <Link href="https://trykode.xyz/docs/themes/">{language.t("common.learnMore")}</Link>
            </>
          }
        >
          <Select
  ...
  return (
    <div class="flex flex-col h-full overflow-y-auto no-scrollbar px-4 pb-10 sm:px-10 sm:pb-10">
      ...
      <div class="flex flex-col gap-8 w-full">
        ...
        <Show when={desktop() && import.meta.env.VITE_KODE_CHANNEL === "beta"}>
          <AdvancedSection />
        </Show>
      </div>
    </div>
