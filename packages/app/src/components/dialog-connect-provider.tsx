import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@kode/sdk/v2/client"
...
import { List, type ListRef } from "@kode/ui/list"
  ...
  function ApiAuthView() {
    ...
    return (
      <div class="flex flex-col gap-6">
        <Switch>
          <Match when={provider().id === "kode"}>
            <div class="flex flex-col gap-4">
              <div class="text-14-regular text-text-base">{language.t("provider.connect.kodeZen.line1")}</div>
              <div class="text-14-regular text-text-base">{language.t("provider.connect.kodeZen.line2")}</div>
              <div class="text-14-regular text-text-base">
                {language.t("provider.connect.kodeZen.visit.prefix")}
                <Link href="https://trykode.xyz/zen" tabIndex={-1}>
                  {language.t("provider.connect.kodeZen.visit.link")}
                </Link>
                {language.t("provider.connect.kodeZen.visit.suffix")}
              </div>
            </div>
          </Match>
          <Match when={true}>
