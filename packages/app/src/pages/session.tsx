import type { Project, UserMessage } from "@kode/sdk/v2"
...
import { createAutoScroll } from "@kode/ui/hooks"
...
export default function Page() {
  ...
  const isV2NewSessionPage = () =>
    shouldUseV2NewSessionPage({ channel: import.meta.env.VITE_KODE_CHANNEL, sessionID: params.id })
