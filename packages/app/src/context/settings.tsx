  ...
  init: () => {
    ...
    return {
      ...
      general: {
        ...
        onboardingCompleted: withFallback(
          () => store.general?.onboardingCompleted,
          defaultSettings.general.onboardingCompleted,
        ),
        setOnboardingCompleted(value: boolean) {
          setStore("general", "onboardingCompleted", value)
        },
      },
      updates: {
