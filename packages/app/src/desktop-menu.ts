...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    label: "Help",
    items: [
      { type: "item", label: "Kode Documentation", href: "https://trykode.xyz/docs" },
      { type: "item", label: "Support Forum", href: "https://discord.com/invite/kode" },
      { type: "item", label: "Export Logs...", command: "logs.export" },
      { type: "separator" },
      {
        type: "item",
        label: "Share Feedback",
        href: "https://github.com/sicario-labs/kode/issues/new?template=feature_request.yml",
      },
      {
        type: "item",
        label: "Report a Bug",
        href: "https://github.com/sicario-labs/kode/issues/new?template=bug_report.yml",
      },
    ],
  },
]
