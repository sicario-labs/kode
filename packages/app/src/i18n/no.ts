...
export const dict = {
  ...
  "dialog.provider.kode.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.kode.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.kodeGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Kode",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Kode.",
  ...
  "provider.connect.kodeZen.line1":
    "Kode Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.kodeZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.kodeZen.visit.prefix": "Besøk ",
  "provider.connect.kodeZen.visit.link": "trykode.xyz/zen",
  "provider.connect.kodeZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Kode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Kode.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i kode.json",
  ...
  "dialog.server.description": "Bytt hvilken Kode-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Kode ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Kode-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (kode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Kode ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Kode inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Kode-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Kode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Kode ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Kode skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Kode er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Kode starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Kode.",
