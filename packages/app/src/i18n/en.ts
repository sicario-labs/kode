export const dict = {
  ...
  "dialog.provider.kode.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.kode.tagline": "Reliable optimized models",
  "dialog.provider.kodeGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Kode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Kode.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.kodeZen.line1":
    "Kode Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.kodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.kodeZen.visit.prefix": "Visit ",
  "provider.connect.kodeZen.visit.link": "trykode.xyz/zen",
  "provider.connect.kodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Kode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Kode.",
  ...
  "dialog.plugins.empty": "Plugins configured in kode.json",
  ...
  "dialog.server.description": "Switch which Kode server this app connects to.",
  ...
  "toast.update.description": "A new version of Kode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Kode team",
  ...
  "error.chain.checkConfig": "Check your config (kode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Kode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Kode includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Kode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Kode",
  ...
  "settings.general.row.appearance.description": "Customise how Kode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Kode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Kode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Kode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Kode.",
