export const dict = {
  ...
  "dialog.provider.kode.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.kode.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.kodeGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Kode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Kode.",
  ...
  "provider.connect.kodeZen.line1":
    "Kode Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  "provider.connect.kodeZen.line2":
    "Z jednym kluczem API uzyskasz dostęp do modeli takich jak Claude, GPT, Gemini, GLM i więcej.",
  "provider.connect.kodeZen.visit.prefix": "Odwiedź ",
  "provider.connect.kodeZen.visit.link": "trykode.xyz/zen",
  "provider.connect.kodeZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Kode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Kode.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w kode.json",
  ...
  "dialog.server.description": "Przełącz serwer Kode, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Kode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Kode",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (kode.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "Kode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Kode",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Kode na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Kode ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Kode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Kode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Kode.",
